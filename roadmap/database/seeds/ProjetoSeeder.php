...
class ProjetoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Projeto::create(['descricao' => 'DECRFIDVEN-1', 'equipe_id' => 1, 'status' => 1, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'CANCRFID-1', 'equipe_id' => 1, 'status' => 1, 'status_aprovacao' => 2]);
        ...
        Projeto::create(['descricao' => 'MELHORIAVP-1', 'equipe_id' => 1, 'status' => 1, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'SCANNERJAD-1', 'equipe_id' => 1, 'status' => 2, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'TORVCCORTE-1', 'equipe_id' => 1, 'status' => 1, 'status_aprovacao' => 2]);
        ...
        Projeto::create(['descricao' => 'MAKESTACI-1', 'equipe_id' => 1, 'status' => 2, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'NESPRESSO-1', 'equipe_id' => 4, 'status' => 2, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'PR-21', 'equipe_id' => 1, 'status' => 1, 'status_aprovacao' => 2]);
        ...
        Projeto::create(['descricao' => 'SPACECARD-1', 'equipe_id' => 1, 'status' => 2, 'status_aprovacao' => 2]);
        ...
        Projeto::create(['descricao' => 'DESIMPTEF-1', 'equipe_id' => 1, 'status' => 1, 'status_aprovacao' => 2]);
        ...
        Projeto::create(['descricao' => 'SENHADIA-1', 'equipe_id' => 2, 'status' => 0, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'TROCACPLJ-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'SAIDAOPER-1', 'equipe_id' => 1, 'status' => 1, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'MELHORIASAPP-1', 'equipe_id' => 5, 'status' => 0, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'PAYFACEAPP-1', 'equipe_id' => 5, 'status' => 0, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'MZCANCANT-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 2]);
        ...
        Projeto::create(['descricao' => 'CRMONEID-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'TENDENCIA-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'FACTURAA4-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'VALIDAEP-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'SORTEIOFIN-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'CADSORTEIO-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'AUDITTROCA-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'PERTO-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'INTMELIUZ-1', 'equipe_id' => 1, 'status' => 1, 'status_aprovacao' => 1]);
        ...
        Projeto::create(['descricao' => 'VPTELAPDV-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'PROMOLISTA-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'LOGVOUCHER-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'APPDMCARD-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        ...
        Projeto::create(['descricao' => 'INTJOYA-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 1]);
        Projeto::create(['descricao' => 'ORDEMSERV-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 2]);
        Projeto::create(['descricao' => 'AJUSTNFCE-1', 'equipe_id' => 1, 'status' => 1, 'status_aprovacao' => 2]);
        ...
        Projeto::create(['descricao' => 'LISTADESC-1', 'equipe_id' => 1, 'status' => 0, 'status_aprovacao' => 0]);
